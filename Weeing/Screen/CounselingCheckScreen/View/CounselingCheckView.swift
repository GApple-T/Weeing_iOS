...
@ViewBuilder
func CheckView(toggleColors: Binding<[Bool]>, count: Int) -> some View {
    ZStack {
        ...
        HStack {
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    Button(action: {
                        toggleColors.wrappedValue[count].toggle()
                    }) {
                        RoundedRectangle(cornerRadius: 3)
                            .frame(width: 18, height: 18)
                            .foregroundStyle(toggleColors.wrappedValue[count] ? Color.white : Color.P30)
                            .background(
                                RoundedRectangle(cornerRadius: 3)
                                    .stroke(toggleColors.wrappedValue[count] ? Color.gray : Color.P30, lineWidth: 2)
                            )
                            .overlay(
